...
║          ╠═╝║  ║╣ ║║║║ ║║║║ ║   ║║║╠═╣╚═╗             ║
║          ╩  ╩═╝╚═╝╝╚╝╚═╝╝╚╝ ╩   ╚╩╝╩ ╩╚═╝             ║
║                    AL AMIN WPS WIFI HACK                    ║
╠══════════════════════════════════════════════════════════╣
║  \033[1;93m[•] Author    : AL AMIN                                \033[1;92m║
║  [•] Team      : Crackers community                         ║
║  [•] Channel   : @Blackgaming928                      ║
║  [•] Version   : WPS Pro 3.0                             ║
╠══════════════════════════════════════════════════════════╣
║  \033[1;96m[✓] WPS Attack Methods:                                 \033[1;92m║
║      → Pixie Dust Attack                                   ║
║      → PIN Bruteforce                                      ║
║      → Null PIN Attack                                      ║
║      → WPS Push Button                                      ║
╠══════════════════════════════════════════════════════════╣
║  \033[1;93m[!] One Line Command:                                   \033[1;92m║
║      sudo python Wifi_Hack/alaminwps.py -i wlan0 -K       ║
║                                                             ║
║  [?) For Help Type:                                         ║
║      python Wifi_Hack/alaminwps.py --help                  ║
╚══════════════════════════════════════════════════════════╝\033[0m
''')
